---
title: <center> "Geographically Weighted Logistic Regression in Credit Risk Analysis" </center>
...
# basically I selected Porto Alegre zip codes which are the ones that start with 90 and 91, are a total of 3551 obs. Then I selected those from the analysis sample with 2128 obs
# of those 2128 obs I was able to find the latitude and longitude of 2014 obs
# zip code in Brazil are called CEP's

# filtering zip codes only from Porto Alegre
data_cep <- data %>%
...
lat_long_POA <- read_excel("lat_long_POA.xlsx") # from 2128 obs I found latitudes and longitudes of 2014 obs
