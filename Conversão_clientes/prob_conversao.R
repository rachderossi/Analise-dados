...
# probabilidade de conversao (em porcentagem)
prob_conversao <- (nivel_bancarizacao$IDHM^CP)*(teledensidade_estad/1.5)*100

# numero de clientes convertidos
